...
public interface CartMapper {
	...
	//
	@Insert("insert into user_cart(userNum, gdsNum,cartCount,cartColor) values(#{userNum},#{gdsNum},#{cartCount},#{cartColor})")
	void addCart(GdsCartDTO gdsCartDTO);
	
	@Delete("delete from user_cart where cartnum= #{cartNum}")
