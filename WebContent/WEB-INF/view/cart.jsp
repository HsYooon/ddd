			...
			<table class="shopping_cart">
				...
				<tbody>
					...
					<c:forEach var="dto" items="${CartList}">
						...
						<tr id="tr_value">
							...
							<td> ${dto.gdsName }<br> <a class="cartOption">[옵션] color : ${dto.cartColor} </a>
							</td>
							<td>
							...
							<td><fmt:formatNumber value="${dto.gdsPrice*dto.cartCount*0.02}" type="number" maxFractionDigits="3"/></td>
							<td><fmt:formatNumber value="${dto.gdsPrice}" type="number" maxFractionDigits="3"/></td>
							<td>[기본배송]<br>조건
							</td>
				...
				<tfoot class="cartFootLine">
					...
					<tr>
						<td colspan="8">
							<div class="cartFoot">
								총 구매금액 : <fmt:formatNumber  value="${cal }" type="number" maxFractionDigits="3" />원 
								<strong><fmt:formatNumber  value="${cal }" type="number" maxFractionDigits="3" />원</strong> 
								(적립금 : <fmt:formatNumber value= "${cal*0.02}" type="number" maxFractionDigits="3"/>원)<br>
							</div>
						</td>
					</tr>
					<!-- 장바구니 적립금 안내 -->
